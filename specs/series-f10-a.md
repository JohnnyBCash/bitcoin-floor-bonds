# Floor Bond Series F10-A (Senior, 10-Year Fixed Coupon)

## Product Summary

| Parameter | Value |
|-----------|-------|
| Product | Series F10-A |
...
| Target buyer | Endowments, sovereign wealth funds, long-duration insurance mandates |

## Risk Profile

Investment grade equivalent. Same protections as F5-A with longer duration. Additional duration risk compensated by 10 years of structural floor growth on collateral.
