...
```
whitepaper/          The definitive document (v0.6)
specs/               12 product specs + common parameters + waterfall + tranche mechanics
research/            Formal verification, volatility decay, BFR, reflecting barrier, 1.6x rule
tools/               Reference implementations (Python)
  coupon_calculator.py
  leverage_analyzer.py
  zero_coupon_pricer.py
  collateral_monitor.py
  threshold_calculator.py
  monte_carlo_validator.py
examples/            Issuance walkthrough, stress scenarios, monitoring templates
data/                Price data, power law parameters, percentile tables, MC simulations
```
